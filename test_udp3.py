...
def main():
    ...
    param.input_param.socket_recv_buf = 4 * 1024 * 1024
    param.input_param.use_vlan = False
    param.input_param.user_layer_bytes = 0
    param.input_param.tail_layer_bytes = 0

    param.decoder_param.wait_for_difop = True
    param.decoder_param.min_distance = 0.2
    param.decoder_param.max_distance = 200.0
